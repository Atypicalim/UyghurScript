...
// compares
#define SIGN_LESS "<"
#define SIGN_LESS_EQL "<="
#define SIGN_MORE ">"
#define SIGN_MORE_EQL ">="
// bool
#define SIGN_NOT "^"
#define SIGN_AND "&"
#define SIGN_ORR "|"
...
#define TVALUES_SIGN_OPENERS 3, SIGN_OPEN_SMALL, SIGN_OPEN_MIDDLE, SIGN_OPEN_BIG
#define TVALUES_SIGN_CLOSERS 3, SIGN_CLOSE_SMALL, SIGN_CLOSE_MIDDLE, SIGN_CLOSE_BIG

const char *TVAUE_GROUP_CALCULATION_ALL[] = {
    SIGN_QUEST, SIGN_LESS, SIGN_LESS_EQL, SIGN_MORE, SIGN_MORE_EQL, SIGN_CHK, NULL
};

const char *TVAUE_GROUP_CALCULATION_NUM[] = {
    SIGN_ADD, SIGN_SUB, SIGN_MUL, SIGN_DIV, SIGN_MUL_DBL, SIGN_DIV_DBL, SIGN_PER, NULL
};

const char *TVAUE_GROUP_CALCULATION_BOL[] = {
    SIGN_NOT, SIGN_AND, SIGN_ORR, NULL
};

const char *TVAUE_GROUP_CALCULATION_STR[] = {
    SIGN_LNK, SIGN_RPT, NULL
};

const char *TVAUE_GROUP_CALCULATION_1[] = {
    SIGN_ADD, SIGN_SUB, NULL
};
const char *TVAUE_GROUP_CALCULATION_2[] = {
    SIGN_MUL, SIGN_DIV, SIGN_DIV_DBL, SIGN_PER, NULL
};
const char *TVAUE_GROUP_CALCULATION_3[] = {
    SIGN_CHK,
    SIGN_LESS, SIGN_LESS_EQL, SIGN_MORE, SIGN_MORE_EQL,
    SIGN_QUEST, SIGN_NOT, SIGN_AND, SIGN_ORR,
    NULL
};
const char *TVAUE_GROUP_CALCULATION_4[] = {
    SIGN_MUL_DBL, NULL
};
...
//
#define LANG_ERR_SOME_PLACE "%s:%d,%d"
#define LANG_ERR_TOKEN_PLACE LANG_ERR_SOME_PLACE " [%s]"
