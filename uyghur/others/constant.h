...
#define TVAUE_GROUP_CALCULATION_NUM 7, SIGN_ADD, SIGN_SUB, SIGN_MUL, SIGN_DIV, SIGN_MUL_DBL, SIGN_DIV_DBL, SIGN_PER
...
#define TVAUE_GROUP_CALCULATION_2 4, SIGN_MUL, SIGN_DIV, SIGN_DIV_DBL, SIGN_PER
#define TVAUE_GROUP_CALCULATION_3 7, SIGN_CHK, SIGN_LESS, SIGN_MORE, SIGN_QUEST, SIGN_NOT, SIGN_AND, SIGN_ORR
#define TVAUE_GROUP_CALCULATION_4 1, SIGN_MUL_DBL
