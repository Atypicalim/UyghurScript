...
#define TVAUES_GROUP_UTYPES 6, TVALUE_EMPTY, TVALUE_LOGIC, TVALUE_NUM, TVALUE_STR, TVALUE_BOX, TVALUE_FUNCTION
...
#define TVAUES_GROUP_CONVERT 6, TVALUE_EMPTY, TVALUE_LOGIC, TVALUE_NUM, TVALUE_STR, TVALUE_FUNCTION, TVALUE_OPPOSITE
