...
#define TVAUES_GROUP_UTYPES 6, TVALUE_EMPTY, TVALUE_LOGIC, TVALUE_NUM, TVALUE_STR, TVALUE_LST, TVALUE_DCT
...
#define TVAUES_GROUP_CONVERT 5, TVALUE_EMPTY, TVALUE_LOGIC, TVALUE_NUM, TVALUE_STR, TVALUE_OPPOSITE
#define TVAUES_GROUP_NICKNAME 3, TVALUE_THIS, TVALUE_MODULE, TVALUE_GLOBAL

#define TVAUE_GROUP_CALCULATION_ALL 4, TVALUE_SIGN_EQUAL, TVALUE_SIGN_LESS, TVALUE_SIGN_MORE, TVALUE_SIGN_PER
#define TVAUE_GROUP_CALCULATION_NUM 5, TVALUE_SIGN_ADD, TVALUE_SIGN_SUB, TVALUE_SIGN_MUL, TVALUE_SIGN_DIV, TVALUE_SIGN_POW
