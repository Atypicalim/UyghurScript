...
// const char *TVALUES_EXP[] = {TTYPE_NUMBER, TTYPE_STRING};

char *TTYPES_GROUP_DEFINE[] = {TTYPE_NAME, TTYPE_STRING, TTYPE_NUMBER, TTYPE_BOOL, TTYPE_EMPTY};
char *TTYPES_GROUP_STRING[] = {TTYPE_NAME, TTYPE_STRING};
char *TTYPES_GROUP_NUMBER[] = {TTYPE_NAME, TTYPE_NUMBER};
char *TTYPES_GROUP_LOGICS[] = {TTYPE_NAME, TTYPE_BOOL, TTYPE_EMPTY};
