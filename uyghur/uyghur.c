...
{
    this->TTYPES_GROUP_DEFINE = S2Q(5, TTYPE_NAME, TTYPE_STRING, TTYPE_NUMBER, TTYPE_BOOL, TTYPE_EMPTY);
    this->TTYPES_GROUP_STRING = S2Q(2, TTYPE_NAME, TTYPE_STRING);
    this->TTYPES_GROUP_NUMBER = S2Q(2, TTYPE_NAME, TTYPE_NUMBER);
    this->TTYPES_GROUP_LOGICS = S2Q(3, TTYPE_NAME, TTYPE_BOOL, TTYPE_EMPTY);
}
